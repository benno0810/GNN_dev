...
def main(args, devices):
    ...
    g.ndata['feat']= th.eye(34)
    test123=np.array([True]*34)
    #g.ndata['test_mask']=np.array([True]*34)
    #g.ndata['val_mask']=np.array([True]*34)
    #g.ndata['train_mask']=np.array([True]*34)
    #we set train,val,test 8:1:1
